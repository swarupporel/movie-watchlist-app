...
export const Bookmark: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />
  </svg>
);

export const BookmarkCheck: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />
...
export const Film: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Logo: React.FC<{ height?: number }> = ({ height = 28 }) => (
  <div className="flex items-center gap-2 select-none" style={{ height }}>
    <svg
      height="100%"
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path d="M4 11h16v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8Z" fill="#2563eb" fillOpacity="0.12" />
      <path d="m4 11 16-3" />
      <path d="m4 7 16-3v4l-16 3V7Z" fill="#2563eb" fillOpacity="0.25" />
      <path d="m8 6 1.5-1.5" />
      <path d="m13 5 1.5-1.5" />
      <path d="m18 4 1.5-1.5" />
    </svg>
    <span
